...
declare -A ConfigUbuntuMinimumI386=(
	...
	[dockerimage]='i386/lzwolf-ubuntu'
	[dockertag]=1
	[entrypoint]=test_build_ecwolf
	[prereq]=''
	[type]=test
...
declare -A ConfigUbuntuPackage=(
	...
	[dockerimage]='lzwolf-ubuntu-package'
	[dockertag]=1
...
declare -A ConfigUbuntuPackageI386=(
	...
	[dockerimage]='i386/lzwolf-ubuntu-package'
	[dockertag]=1
	[entrypoint]=package_ecwolf
