...
#ifndef PAK_H_INCGUARD
#define PAK_H_INCGUARD
...
dirsection *inPak(const char *file, pakfile *fp);			//checks if a file exists within a pakfile
...
Mix_Chunk *loadWAV(char* file, pakfile *fp);			//loads a WAV from a PAK into Mix_Chunk directly
